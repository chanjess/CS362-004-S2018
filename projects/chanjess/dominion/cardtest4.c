...
int main() 
{
    ...
    printf("TESTING ----- VILLAGE ROOM CARD()\n");
    ...
    printf("Playing...Village Room Card\n");
    cardEffect(village, choice1, choice2, choice3, &G2, handpos, &bonus);
    printf("TESTING ***** Player 1 gaining 1 card *****\n"); 
    printf("actual = %d, expected = 5\n", G2.handCount[0]);
    assertTrue(G2.handCount[0], G.handCount[0]);

    printf("TESTING ***** Player 1 gains 1 cards from own pile ***** \n");
    printf("actual = %d, expected = %d\n", G2.deckCount[0], G.deckCount[0]-1);
    assertTrue(G2.deckCount[0], G.deckCount[0]-1);

    printf("TESTING ***** Player 1 gaining 2 action *****\n"); 
    printf("actual = %d, expected = 3\n", G2.numActions);
    assertTrue(G2.numActions, G.numActions + 2);
